...
class AbstractCat extends StatefulWidget {
  ...
  const AbstractCat({Key? key, this.onMenuPageButtonPressed, required this.title, required this.pageToPush}) : super(key: key);
...
class ScrollPage extends StatefulWidget {
  ...
  const ScrollPage({Key? key, required this.title, required this.pageToPush}) : super(key: key);

  @override
  State<ScrollPage> createState() => _ScrollPageState(this.title, this.pageToPush);
}
...
class Language extends StatelessWidget {
  ...
  const Language({Key? key, required this.index, required this.title, required this.pageToPush}) : super(key: key);
