      ...
      onTap: () {
        switch (index) {
          case 0:
            ...
            List<String> title = ['Schimbare ulei', 'Verificare presiune anvelope', 'Inlocuire filtre aer'];
          ...
          case 2:
            ...
            List<String> title = ['Folosire centuri de siguranta', 'Instalare scaun copil', 'Conducere in conditii de iarna'];
            List<Widget> pageToPush = [Tutorial1()];
          ...
          case 3:
            ...
            List<String> title = ['Curatare interior masina', 'Spalare masina', 'Curatare faruri'];
            List<Widget> pageToPush = [Tutorial1()];
          ...
          case 4:
            ...
            List<String> title = ['Folosire GPS', 'Citire harta rutiera', 'Planificare traseu'];
            List<Widget> pageToPush = [Tutorial1()];
