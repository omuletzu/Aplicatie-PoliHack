...
import 'package:polihack2024/Tutorial1.dart';
import 'package:polihack2024/general_subcat.dart';

class MenuPageHome extends StatefulWidget {
  final VoidCallback? onMenuPageButtonPressed;

  const MenuPageHome({Key? key, this.onMenuPageButtonPressed}) : super(key: key);
      ...
      onTap: () {
        switch (index) {
          case 0:
            ...
            List<String> title = ['Schimbare priza', 'Schimbare bec', 'Schimbare intrerupator lumina'];
          ...
          case 1:
            ...
            List<String> title = ['Inlocuire robinet', 'Deblocare canal', 'Inlocuire toaleta'];
            List<Widget> pageToPush = [Tutorial1()];
          ...
          case 2:
            ...
            List<String> title = ['Plantare legume', 'Ingrijire plante', 'Taiere gazon'];
            List<Widget> pageToPush = [Tutorial1()];
          ...
          case 3:
            ...
            List<String> title = ['Preparare mancare de baza', 'Utilizare eficienta cuptor', 'Conserve homemade'];
            List<Widget> pageToPush = [Tutorial1()];
          ...
          case 4:
            ...
            List<String> title = ['Curatare diverse suprafete', 'Organizare eficienta obiecte', 'Eliminare pete dificile'];
            List<Widget> pageToPush = [Tutorial1()];
          ...
          case 5:
            ...
            List<String> title = ['Reparare scaun', 'Vopsire perete', 'Montare raft'];
            List<Widget> pageToPush = [Tutorial1()];
