              ...
              child: Column(
                ...
                children: [
                  TutorialStep(
                    stepNumber: 1,
                    description:
                        'Opreşte curentul în casă. Introdu vârful şurubelniţei-tester în ambele orificii ale prizei, ţinând un deget pe contactul metalic din capătul mânerului.Rezistenţa din interiorul testerului trebuie să fie stinsă. Desfă şuruburile prizei vechi şi îndepărtează capacul.',
                  ),
                  TutorialStep(
                    stepNumber: 2,
                    description:
                        'Corpul prizei are pe laterale două şuruburi care trebuie şi ele desfăcute. Când priza se poate scoate din perete, apuc-o de părţile ceramice.În partea din spatele ei se află două orificii în care intră cele două fire metalice.Acestea sunt prinse în priză cu două şurubele. Slăbeşte-le pentru a le scoate şi a te uita la ele.',
                  ),
                  TutorialStep(
                    stepNumber: 3,
                    description:
                        'Dacă izolaţia din plastic este casantă sau înnegrită, tai-o cu un cuţit atât cât este nevoie.Apoi, îndepărtează din nou izolaţia pe o porţiune de câţiva milimetri. Introdu capetele metalice în orificiile din spatele noii prize şi strânge din nou şuruburile până când firele stau fixe.',
                  ),
                  TutorialStep(
                    stepNumber: 4,
                    description:
                        'Introdu priza înapoi în perete, iar apoi strânge şuruburile laterale. Pune capacul şi strânge-i şuruburile.',
                  ),
                  TutorialStep(
                    stepNumber: 5,
                    description:
